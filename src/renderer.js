    ...
    async function init(AMap, map) {
        ...
        const higherTemperature = document.querySelector('#higherTemperature');
        higherTemperature.addEventListener('change', () => {
            console.log('higherTemperature', higherTemperature.value)
            storage.setItem('higherTemperature', higherTemperature.value);
            return true;
        });
        const lowerTemperature = document.querySelector('#lowerTemperature');
        lowerTemperature.addEventListener('change', () => {
            console.log('lowerTemperature', lowerTemperature.value)
            storage.setItem('lowerTemperature', lowerTemperature.value);
            return true;
        });
